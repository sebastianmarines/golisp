...
func TestFunctions(t *testing.T) {
	...
	tests := []struct {
		...
		// (fn* (a) a) => #<function>
		{input: ast.Node{Type: ast.List, Children: []*ast.Node{{Type: ast.Symbol, Value: "fn*"}, {Type: ast.List, Children: []*ast.Node{{Type: ast.Symbol, Value: "a"}}}, {Type: ast.Symbol, Value: "a"}}}, expected: "#<function>"},
		// ((fn* (a) a) 1) => 1
		{input: ast.Node{Type: ast.List, Children: []*ast.Node{{Type: ast.List, Children: []*ast.Node{{Type: ast.Symbol, Value: "fn*"}, {Type: ast.List, Children: []*ast.Node{{Type: ast.Symbol, Value: "a"}}}, {Type: ast.Symbol, Value: "a"}}}, {Type: ast.Number, Value: 1}}}, expected: "1"},
		// ((fn* (a) (+ a 1)) 1) => 2
